    ...
    <footer className="py-16 px-6 md:px-12 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div>
            <h3 className="text-2xl mb-4">AURA</h3>
            <p className="text-gray-600 text-sm">
              Elevating everyday style with timeless elegance
            </p>
          </div>
          
          <div>
            <h4 className="mb-4 tracking-wider uppercase text-sm">Shop</h4>
          ...
          <div>
            <h4 className="mb-4 tracking-wider uppercase text-sm">Support</h4>
            <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div>
            <h4 className="mb-4 tracking-wider uppercase text-sm">Follow Us</h4>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 flex items-center justify-center border border-gray-300 hover:border-black transition-colors">
